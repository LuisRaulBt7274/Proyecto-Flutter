...
class EjerciciosPorTemaPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ejercicios = _getEjerciciosForSubtemas(subtema);
  ...
  Widget _buildEjercicioCard(BuildContext context, String ejercicio, String resultado, MaterialColor color) {
    return Card(
      margin: const EdgeInsets.only(bottom: 16),
      elevation: 4,
      shape: RoundedRectangleBorder(
  ...
  List<Map<String, String>> _getEjerciciosForSubtemas(String subtema) {
    ...
    if (subtema == 'Primera Condición de Equilibrio') {
    ...
    } else if (subtema == 'Segunda Condición de Equilibrio (Equilibrio Rotacional)') {
      return [
        {
    ...
    } else if (subtema == 'Movimiento Circular Uniforme (MCU) y Movimiento Circular Uniformemente Variado (MCUV)') {
      return [
        {
    ...
    } else if (subtema == 'Cantidad de Movimiento e Impulso') {
      return [
        {
          'ejercicio':
    ...
    } else if (subtema == 'Principio de Pascal y Arquímedes') {
      return [
        {
          'ejercicio':
    ...
    } else if (subtema == 'Arreglo de Capacitores') {
      return [
        {
          'ejercicio':
    ...
    } else if (subtema == 'Resistividad, Resistencia Eléctrica y Ley de Ohm') {
      return [
        {
          'ejercicio':
    ...
    } else if (subtema == 'Potencia Eléctrica y Pérdida de Calor') {
      return [
        {
          'ejercicio':
    ...
    } else if (subtema == 'Resistencia con Temperatura') {
      return [
        {
          'ejercicio':
    ...
    } else if (subtema == 'Fuerza Electromotriz y Resistencia Interna') {
      return [
        {
          'ejercicio': 'Una batería tiene una fuerza electromotriz (FEM) de 12 V y una resistencia interna de 0.5 Ω. Si se conecta a un resistor externo de 5.5 Ω, ¿cuál es la corriente que circula por el circuito y el voltaje terminal de la batería?',
          'resultado': '2 A, 11 V',
        },
        {
          'ejercicio': 'Una fuente de poder de 6 V suministra 1.5 A a una carga. Si el voltaje terminal medido es de 5.8 V, calcula la resistencia interna de la fuente.',
          'resultado': '0.13 Ω',
        },
      ];
    ...
    } else if (subtema == 'Flujo Magnético y Densidad de Flujo Magnético') {
      return [
        {
      ...
      return [
        ...
        {
          'ejercicio': 'Calcular la intensidad de corriente que debe circular por una bobina de 500 espiras de alambre en el aire, cuyo radio es de 5 cm, para que produzca una inducción magnética en su centro de 7 × 10⁻³ T.',
          'resultado': '1.11 A',
        },
        {
          'ejercicio': 'Calcular la longitud que debe tener un solenoide para que al ser devanado con 600 espiras de alambre sobre un núcleo de hierro, con una permeabilidad relativa de 1.25×10⁴, produzca una inducción magnética de 0.5 T en su centro. Una corriente de 10 mA circula por el alambre.',
          'resultado': '0.189 m',
        },
      ];
    } else if (subtema == 'Ley de Faraday y FEM Inducida') {
      return [
        {
        ...
        {
          'ejercicio': 'Un conductor rectilíneo de 10 cm se mueve perpendicularmente a un campo magnético de 0.4 T, a 3 m/s. ¿Cuál es la FEM inducida?',
          'resultado': '0.12 V',
        },
        {
          'ejercicio': 'El flujo magnético que cruza una espira varía de 2 × 10⁻² a 4 × 10⁻² Wb en 3 × 10⁻² s. ¿Qué FEM media se induce?',
          'resultado': '-0.666 V',
        },
      ];
    } else if (subtema == 'Instrumentos Eléctricos: Amperímetro y Voltímetro') {
      return [
        {
    ...
    } else if (subtema == 'Momento Magnético y Torque Magnético') {
      return [
        {
        ...
        {
          'ejercicio': 'Determinar el momento magnético de un imán rectangular de 18 A·m y 10 cm de longitud en un campo magnético de 1.5 T.',
          'resultado': '1.8 A·m²',
        },
      ];
